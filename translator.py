...
def dk():
    ...
    varname2.set(word3)
def exit():
    rr = messagebox.askyesnocancel('Notification','Are you want to exit')
    if(rr==True):
        root.destroy()
...
#############Buttons######################
btn1 = Button(root,text='Click',bd=10,bg='yellow',fg='black',activebackground='red',width=10,font=('times',15,'italic bold'),command=dk)
btn1.place(x=70,y=170)

btn2 = Button(root,text='Exit',bd=10,bg='yellow',fg='black',activebackground='red',width=10,font=('times',15,'italic bold'),command=exit)
